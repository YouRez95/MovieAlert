...
exports.updateMovieHandler = exports.myViewsHandler = exports.myMoviesHandler = exports.mostAndNewMovieHandler = exports.aboutMovieHandler = exports.searchMovieHandler = exports.addMovieHandler = void 0;
...
exports.addMovieHandler = (0, catchErrors_1.default)(async (req, res) => {
    ...
    return res.status(http_1.OK).json({ message: 'movie created' });
});
